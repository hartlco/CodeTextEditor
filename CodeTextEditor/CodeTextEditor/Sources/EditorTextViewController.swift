...
final class EditorTextViewController: NSViewController, NSTextViewDelegate, NSTextStorageDelegate {
    ...
    override func viewDidLoad() {
        ...
        textView?.string = "# hallloo"
        textView?.font = NSFont(name: "Menlo", size: 18)!
